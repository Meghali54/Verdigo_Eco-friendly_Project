export function LoadingSkeleton() {
  return (
    <div className="space-y-8 animate-pulse">
      {/* AQI Header Skeleton */}
      <div className="bg-gray-200 dark:bg-gray-700 rounded-2xl p-6 border dark:border-gray-600">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-gray-200 dark:bg-gray-700 rounded-xl p-4 border dark:border-gray-600">
                ...
                <div className="bg-gray-300 dark:bg-gray-600 rounded-full h-2 mb-2"></div>
        ...
        <div className="bg-gray-200 dark:bg-gray-700 rounded-2xl p-6 border dark:border-gray-600">
          ...
          <div className="space-y-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-gray-300 dark:bg-gray-600 rounded-lg h-12"></div>
            ))}
          </div>
        </div>
      </div>
