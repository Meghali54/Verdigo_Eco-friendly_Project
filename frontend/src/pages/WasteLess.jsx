    ...
    <div className='min-h-screen bg-background'>
      ...
      <main className='container mx-auto px-6 py-8'>
        <div className='text-center'>
          <h2 className='text-3xl font-bold text-card-foreground mb-4'>Coming Soon</h2>
          <p className='text-muted-foreground text-lg'>WasteLess feature is under development</p>
        </div>
      </main>
    </div>
  )
