        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">Air Buddy</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              {currentData && (
                <button
                  ...
                  disabled={loading}
                  className="flex items-center space-x-2 px-4 py-2 bg-primary hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground text-primary-foreground rounded-lg transition-colors"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading && (
          <div className="bg-card rounded-2xl shadow-xl border border-border p-12 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-muted-foreground text-lg">Fetching air quality data...</p>
            </div>
          </div>
        )}
        ...
        {currentData && !loading && (
          <div className="space-y-8">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-muted rounded-xl p-6">
                    <h4 className="text-lg font-semibold text-foreground mb-4">Health Recommendations</h4>
            ...
            {/* Pollutant Details */}
            <div className="bg-card rounded-2xl shadow-xl border border-border p-6">
              <h3 className="text-2xl font-bold text-foreground mb-6">Pollutant Breakdown</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-semibold text-foreground">CO</h4>
                    <div className="text-2xl font-bold text-gray-700">{currentData.airQuality.co}</div>
                  </div>
                  <p className="text-sm text-muted-foreground">Carbon monoxide mg/m³</p>
            ...
            <div className="bg-card rounded-2xl shadow-xl border border-border p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{currentData.weather.temperature}°C</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{currentData.weather.humidity}%</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{currentData.weather.windSpeed} km/h</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{currentData.weather.visibility || 'N/A'} km</div>
