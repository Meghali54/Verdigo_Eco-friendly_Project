  ...
  const features = [
    {
      ...
      hoverColor: "group-hover:from-emerald-500 group-hover:via-green-600 group-hover:to-teal-700",
    ...
    },
    {
      ...
      hoverColor: "group-hover:from-lime-500 group-hover:via-green-600 group-hover:to-emerald-700",
    ...
    },
    {
      ...
      hoverColor: "group-hover:from-cyan-500 group-hover:via-blue-600 group-hover:to-indigo-700",
    ...
    },
    {
      ...
      hoverColor: "group-hover:from-teal-500 group-hover:via-cyan-600 group-hover:to-blue-700",
    ...
    },
    {
      ...
      hoverColor: "group-hover:from-violet-500 group-hover:via-purple-600 group-hover:to-fuchsia-700",
  ...
  const quickStats = [
    {
      ...
      value: "30 kg",
      change: "+0%",
      icon: <TreePine className="w-6 h-6 text-green-600 group-hover:text-green-700 transition-colors duration-300" />,
      ...
      iconBg: "bg-gradient-to-br from-green-100 to-green-200 group-hover:from-green-200 group-hover:to-green-300",
    ...
    },
    {
      ...
      value: "750",
      change: "+12%",
      icon: <Star className="w-6 h-6 text-amber-600 group-hover:text-amber-700 transition-colors duration-300" />,
    ...
    },
    {
      ...
      value: "8",
      change: "+0%",
      icon: <ShoppingBasket className="w-6 h-6 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />,
    ...
    },
    {
      ...
      value: "#1,247",
      change: "+5",
      icon: <TrendingUp className="w-6 h-6 text-violet-600 group-hover:text-violet-700 transition-colors duration-300" />,
      ...
      iconBg: "bg-gradient-to-br from-violet-100 to-violet-200 group-hover:from-violet-200 group-hover:to-violet-300",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-emerald-50/40 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-r from-teal-400/10 to-green-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
            ...
            <div className="flex items-center space-x-4 group">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-medium">
                  Welcome back, <span className="text-emerald-600 font-semibold">{user?.name || "Eco Warrior"}</span>!
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <button className="relative p-3 bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950/30 dark:to-pink-950/30 text-rose-600 hover:from-rose-100 hover:to-pink-100 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-rose-500/20 group">
                ...
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-red-500 to-rose-500 rounded-full text-[10px] text-white flex items-center justify-center font-bold animate-pulse">3</span>
              </button>
      ...
      <main className="container mx-auto px-6 py-8 relative z-10">
        ...
        <div className="relative bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-3xl p-8 text-white mb-8 overflow-hidden group hover:shadow-2xl hover:shadow-emerald-500/30 transition-all duration-500">
          ...
          <div className="absolute inset-0 opacity-30">
            ...
            <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-white/10 rounded-full -translate-x-1/2 -translate-y-1/2 animate-ping" style={{ animationDuration: '3s' }}></div>
          </div>
          ...
          <div data-aos="fade-up" data-aos-delay="100" className="relative z-10">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden lg:block">
                <Globe className="w-36 h-36 text-white/30 animate-spin" style={{ animationDuration: '20s' }} />
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <div className={`p-3 rounded-xl ${stat.iconBg} shadow-md group-hover:scale-125 group-hover:rotate-12 group-hover:shadow-lg transition-all duration-500`}>
                    {stat.icon}
                  </div>
                ...
                <p className="text-muted-foreground font-semibold group-hover:text-foreground transition-colors duration-300">{stat.title}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h4 className={`text-xl font-bold text-card-foreground mb-2 ${feature.textHover} transition-colors duration-300`}>
                        {feature.title}
                      </h4>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border/50 group-hover:border-current/20 transition-colors duration-300">
                        ...
                        <div className={`flex items-center gap-2 text-slate-400 ${feature.textHover} transition-all duration-300`}>
                          <span className="text-sm font-semibold -translate-x-2 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300">Explore</span>
            ...
            {/* Progress Section */}
            <div data-aos="fade-up" data-aos-delay="100" className="bg-card/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-border/50 hover:shadow-xl transition-all duration-500 group">
            ...
            {/* Getting Started */}
            <div data-aos="fade-up" data-aos-delay="200" className="bg-card/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-border/50 hover:shadow-xl transition-all duration-500">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-white dark:to-slate-300 bg-clip-text text-transparent mb-6 flex items-center gap-3">
              ...
              <div className="space-y-5">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold text-white shadow-lg group-hover:scale-125 group-hover:rotate-6 group-hover:shadow-xl transition-all duration-500 relative z-10 ${item.completed
          ...
          <div className="space-y-8">
            {/* Recent Activity */}
            <div data-aos="fade-left" data-aos-delay="100" className="bg-gradient-to-br from-card/90 via-card/80 to-blue-50/30 dark:to-blue-950/20 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-blue-200/50 dark:border-blue-800/30 hover:shadow-2xl hover:shadow-blue-500/20 hover:border-blue-300/60 dark:hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-1 group/card">
